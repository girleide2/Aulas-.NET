...
var students = new List<Student>{
   new Student(1, "Gabriel", "123456789", new DateTime(2000, 3, 14), new List<string>{"123456789", "111111111"}),
   new Student(2, "Girleide", "987654321", new DateTime(1999, 10, 25), new List<string>{"123456789", "111111111"}),
   new Student(3, "pessa x", "123456789", new DateTime(1998, 10, 24), new List<string>{"123456789", "111111111"})
};

var any = students.Any();
var anyHelder = students.Any(x => x.FullName.Contains("Girleide"));
